...
<img class="img-simple border rounded p-1 img-fluid lazyload blur-up border-0 rounded-circle" src=/conference/pdf.png width=60 height=60 alt=Square>
</a>
<a href='#' target='_blank'>
<img class="img-simple border rounded p-1 img-fluid lazyload blur-up border-0 rounded-circle" src=/conference/youtube.png width=60 height=60 alt=Square>
</a>
